...
heatmap(ts, z./1e3, max.(6, log10.(total_ionization)))
...
ni_prod[findall(p -> p[2] == "e-", particles)[1]]     = e_prod
ni_prod[findall(p -> p[2] == "O+(4S)", particles)[1]] = e_prod .* n0[i_O , :]*0.56 ./(n0[i_O, :]*0.56 .+ n0[i_N2, :]*0.92 .+ n0[i_O2, :])
ni_prod[findall(p -> p[2] == "O2+", particles)[1]]    = e_prod .* n0[i_O , :]*0.56 ./(n0[i_O, :]*0.56 .+ n0[i_N2, :]*0.92 .+ n0[i_O2, :])
ni_prod[findall(p -> p[2] == "N2+", particles)[1]]    = e_prod .* n0[i_O , :]*0.56 ./(n0[i_O, :]*0.56 .+ n0[i_N2, :]*0.92 .+ n0[i_O2, :])
